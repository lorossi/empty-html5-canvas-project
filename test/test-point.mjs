...
describe("Point test", () => {
  describe("Constructor tests", () => {
    ...
    it("Should instantiate from array", () => {
      const p1 = Point.fromArray([1, 2]);
      chai.expect(p1.x).to.equal(1);
      chai.expect(p1.y).to.equal(2);

      chai.expect(() => Point.fromArray([1])).to.throw();
  ...
  describe("Operations tests", () => {
    it("Should correctly compare Point instances for equality", () => {
      ...
      const p3 = new Point(1 + EPSILON / 2, 1 + EPSILON / 2);
      chai.expect(p1.equals(p3, 0)).to.be.false;
      chai.expect(p1.equals(p3, EPSILON)).to.be.true;
    ...
    it("Should correctly copy Point instances", () => {
      ...
      chai.expect(p1.equals(new Point(1, 1))).to.be.true;
      chai.expect(p2.equals(new Point(2, 2))).to.be.true;
      chai.expect(p1.toArray()).to.deep.equal([1, 1]);
  ...
  describe("Getters and setters tests", () => {
    it("Should correctly provide getters and setters", () => {
      ...
      chai.expect(p.toArray()).to.deep.equal([0, 0]);
